...
let browser_config = {
    ...
    //user_agent: 'Mozilla/5.0 (Linux; Android 10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Mobile Safari/537.36'
...
(async () => {
    ...
    let scrape_config = {
        ...
        //search_engine: 'yahoo_desktop',
          //search_engine: 'bing_desktop',
        //search_engine: 'bing_mobile',
         search_engine: 'google_desktop',
        // search_engine: 'google_mobile',
        // an array of keywords to scrape
        keywords: ['cloud service'],
        // the number of pages to scrape for each keyword
        num_pages: 1,
         scrape_from_string: fs.readFileSync('html/alibaba_google_desktop.html', 'utf8'),
        //scrape_from_string: fs.readFileSync('html/alibaba_google_mobile.html', 'utf8'),
